...
@section('content')
    <div class="col-xxl" style="margin-top: -25px">
        <div class="card mb-4">
            <h5 class="card-header">تعديل التوكيل</h5>
            <form action="{{ route('procuration.update', $procuration->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <button type="submit" class="btn btn-primary m-3">تحديث التوكيل</button>
            </form>
        </div>
    </div>
@endsection
