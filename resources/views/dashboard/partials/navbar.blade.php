                ...
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar avatar-online">
                                        <img src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('images/default-image.jpeg') }}"
                                            class=" rounded-circle" style="width: max-width:200px;border-radius:50%" />
                                    </div>
                                </div>
                    ...
                    <li>
                        <a class="dropdown-item" href="javascript:void(0)"
                            onclick="event.preventDefault(); if(confirm('هل ترغب حقًا في تسجيل الخروج الآن؟')) document.getElementById('logout-form').submit();">
